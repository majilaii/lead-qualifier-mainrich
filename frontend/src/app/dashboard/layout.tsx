...
const NAV_ICONS: Record<string, React.ReactNode> = {
  ...
  "/dashboard/reddit": <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="10" /><path d="M14.5 9a1.5 1.5 0 11-3 0 1.5 1.5 0 013 0z" /><path d="M9 14c.6.9 1.7 1.5 3 1.5s2.4-.6 3-1.5" /><circle cx="8.5" cy="11.5" r="1" /><circle cx="15.5" cy="11.5" r="1" /></svg>,
...
const NAV_ITEMS = [
  ...
  { href: "/dashboard/reddit", label: "Reddit Pulse" },
